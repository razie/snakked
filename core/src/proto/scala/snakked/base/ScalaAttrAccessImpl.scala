...
abstract class ScalaAttrAccessImpl extends AttrAccess {
  ...
  lazy val _types: scala.collection.mutable.HashMap[String, AttrTypex] = new scala.collection.mutable.HashMap[String, AttrType]()
  ...
  def getAttrType(name: String): AttrTypex = {
  ...
  def setAttrType(name: String, ttype: AttrTypex) {
  ...
  def set(name: String, v: Any, t: AttrTypex) {
    setAttrPair(name, v);
    setAttrType(name, t);
  }
